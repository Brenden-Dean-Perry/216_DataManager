...
namespace DataManager_216
{
    public partial class frmHasher : Form
    {
        ...
        private void btn_Hasher_HashText_Click(object sender, EventArgs e)
        {
            ...
            {
                tb_Hasher_HashedValue.Text = GeneralFormLibrary1.Cryptography.ConvertByteArrayToHexadecimalString(GeneralFormLibrary1.Cryptography.HashStringReturnByteArray(HashAlgorithm.Create(selectedAlgo), tb_Hasher_Text.Text));
            }
        ...
        private void btn_Hasher_HashFile_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    tb_Hasher_HashedValue.Text = GeneralFormLibrary1.Cryptography.ConvertByteArrayToHexadecimalString(GeneralFormLibrary1.Cryptography.HashFileReturnByteArray(HashAlgorithm.Create(selectedAlgo), tb_Hasher_File.Text));
                }
            }
        }
    }
